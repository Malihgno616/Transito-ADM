            ...
            echo "
              <tr class='text-lg p-4 mb-3'>
                ...
                <td class='text-white font-bold'>
                  <button data-id='$id' data-modal-target='edit-idoso-modal' data-modal-toggle='edit-idoso-modal' class='border-2 border-yellow-500 rounded-sm p-2 text-yellow-500 hover:bg-yellow-500 hover:dark:text-white duration-150 cursor-pointer'><i class='fa-solid fa-pencil'></i></button>
            ...
            <div class="p-4 md:p-5 space-y-4">
              <form class="max-w-4xl mx-auto">
                ...
                <div class="grid md:grid-cols-4 md:gap-6 ">
                  ...
                  <div class="relative z-0 w-full mb-5 group">
                      <input type="date" name="floating_password" id="floating_password" class="block py-2.5 px-0 w-full text-md text-gray-900 bg-transparent border-0 border-b-2 border-gray-500 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-yellow-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="dd-mm-yyyy" required />
