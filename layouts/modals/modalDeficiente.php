            ...
            <div class="p-4 md:p-5 space-y-4">
              <form class="max-w-4xl mx-auto">
                ...
                <div class="grid md:grid-cols-4 md:gap-6 ">
                  ...
                  <div class="relative z-0 w-full mb-5 group">
                      <select id="" name="floating-genero" class="block py-2.5 px-0 w-full text-md text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-yellow-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                        <option value="">Selecione...</option>
                        <?php foreach($array_generos as $generos): ?>
                            <option value="<?= $generos ?>">
                                <?= $generos ?>
                            </option>
                        <?php endforeach; ?>
                      </select>
                  ...
                  <div class="relative z-0 w-full mb-5 group">
                      <input type="text" name="end-idoso" id="" class="block py-2.5 px-0 w-full text-md text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-yellow-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                  ...
                  <div class="relative z-0 w-full mb-5 group">
                      <input type="text" name="floating_company" id="" class="block py-2.5 px-0 w-full text-md text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-yellow-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" 
                       />
                  ...
                  <div class="relative z-0 w-full mb-5 group">
                    <input type="email" name="floating_company" id="" class="block py-2.5 px-0 w-full text-md text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-yellow-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "  />
